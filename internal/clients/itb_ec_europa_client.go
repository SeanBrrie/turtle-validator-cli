...
func (c *ItbEuropaClient) ShaclValidator(domain string, payload types.ValidationPayload) (bool, error) {
	...
	if err := xml.Unmarshal(body, &validationResp); err != nil {
		return false, fmt.Errorf("failed to unmarshal response: %w", err)
	}

	return validationResp.ValidationReport.Conforms, nil
}
